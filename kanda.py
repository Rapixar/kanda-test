...
class UserSchema(Schema):
    ...
    password = fields.Str(required=True, error_messages={
                          "required": "This is required."}, validate=validate.Length(min=8))  # validate.Length(min=8) is a custom validator, which checks if the password is at least 8 characters long
...
class UserResource:
    ...
    def on_post(self, req, resp):
        ...
        try:
            doc = req.context.doc  # doc is the dictionary of the body of the request payload
...
app = falcon.App(middleware=[  # app is the falcon application object
